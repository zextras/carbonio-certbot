# Makefile for building carbonio-certbot packages using YAP
#
# Usage:
...
help:
	@echo "Carbonio Certbot - Build System"
	@echo ""
	@echo "This Makefile builds carbonio-certbot packages using YAP"
